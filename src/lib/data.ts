...
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(2024, 9, 30, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 9, 30, 13, 0),
    end: new Date(2024, 9, 30, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 9, 30, 14, 0),
    end: new Date(2024, 9, 30, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 10, 1, 9, 0),
    end: new Date(2024, 10, 1, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 10, 1, 10, 0),
    end: new Date(2024, 10, 1, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 10, 1, 11, 0),
    end: new Date(2024, 10, 1, 11, 45),
  },

  {
    ...
    end: new Date(2024, 10, 1, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 10, 2, 8, 0),
    end: new Date(2024, 10, 2, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 10, 2, 10, 0),
    end: new Date(2024, 10, 2, 10, 45),
  },

  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 10, 2, 13, 0),
    end: new Date(2024, 10, 2, 13, 45),
  },
  {
    title: "History",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2024, 10, 3, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 10, 3, 10, 0),
    end: new Date(2024, 10, 3, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
